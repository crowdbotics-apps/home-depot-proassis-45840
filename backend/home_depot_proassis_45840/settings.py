"""
Django settings for home_depot_proassis_45840 project.
...
ROOT_URLCONF = 'home_depot_proassis_45840.urls'
...
WSGI_APPLICATION = 'home_depot_proassis_45840.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "home_depot_proassis_45840 API",
    "DESCRIPTION": "API documentation for home_depot_proassis_45840 App",
    "VERSION": "v1",
}
